...
REGISTRY ?= docker.pkg.github.com/selithrarion/go_perfect-test-template
...
BUILD_IMAGE ?= golang:1.16.4-alpine3.13
# Tweaked image used for test runs (see `test.Dockerfile`)
TEST_IMAGE ?= selithrarion/golang:1.16.4-alpine3.13
